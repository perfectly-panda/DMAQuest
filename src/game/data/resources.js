...
export var ResourceItems = {
    ...
    'chipmunks': new Resource('Chipmunks', 'How many chipmunks came in', new BonusObject('chipmunkTick', 'chipmunks', 0 /* add */, 0, [], [], new Identifier(Type.resource, 'shipmunks', ''))),
    'portals': new Resource('Portals', 'Wizard summoning protals', new BonusObject('portalTick', 'people', 0 /* add */, 0, [], [], new Identifier(Type.resource, 'portals', '')))
};
